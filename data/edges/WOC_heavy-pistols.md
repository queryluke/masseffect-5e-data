...
mechanics:
  - type: other
    name: 'Weapon of Choice: Heavy Pistols'
    damage:
      - dieCount: 1
        dieType:
          type: progressive
    ...
    shortDesc: >-
      When you attack with a heavy pistol, add {{ damage }} to the attack or damage roll. If you choose the damage roll, the
  ...
  - type: reaction
    ...
    damage:
      - dieCount: 1
        ...
        label: 'Superiority Die'
    shortDesc: >-
      When you are hit by a melee attack and holding a heavy pistol, add {{ damage }} to your AC. If the attack still hits, take half damage.
    resource:
      reset: short
      label: 'd8s / short rest'
      max:
...
* When you make a weapon attack against a creature with a heavy pistol, you can expend one superiority die to add
...
* When you damage a creature with a heavy pistol, you can expend one superiority die to add
...
* When you are hit by a melee attack, if you are currently holding a heavy pistol, you can expend one superiority
